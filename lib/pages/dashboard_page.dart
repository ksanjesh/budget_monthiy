...
import 'package:budget_monthly/pages/your_balance_page.dart';
import 'package:budget_monthly/themes/colors.dart';
                    ...
                    children: [
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          SizedBox(height: 8,),
                          Text("when you register for an account.",style: TextStyle(fontSize: 14),),
                          SizedBox(height: 8,),
                          Text("we collect personal information.",style: TextStyle(fontSize: 14),),
                          SizedBox(height: 12,),
